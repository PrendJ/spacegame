...
- Deliver a single, polished 2D grid experience with responsive visuals and momentum scoring.
...
- Random pickups can heal the player or clear enemy bullets when collected.
- Momentum increases with consecutive eliminations, boosting score until the streak cools off.
...
- [ ] Selecting difficulty updates panel labels correctly.
...
- [ ] Pickups apply the expected effect when collected.
